...
ipcRenderer.on('resized', (event, size) => {
    var height = size[1];
    document.getElementById('thumbnail-column').setAttribute('style', `height: ${height - 100}px`)
    document.getElementById('board-column').setAttribute('style', `height: ${height - 100}px`)
});
